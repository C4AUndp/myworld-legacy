...
function ready() {
  ...
  results_UI2();
  results_Segments2(segments);

  results_UI3();
  results_Segments3(segments);
}


var counters = function () {

  var countryCholder = $("#cnumber-header");
  ...
  for (var i=0; i<13; i++){
    if (i==1 || i==5 || i==9) {
      ...
      peopleCholder.append($('<span class="countbig" id="peopleC'+i+'">'+peopleC[pc-pm]+'</span>'));
      pc++;
    }
    else {
      peopleCholder.append($('<span class="countbig" id="peopleC'+i+'">&nbsp;</span>'));
      pc++;
    }
  }

  $.each(countryC, function(index, item){
    countryCholder.append($('<span class="countbig">'+item+'</span>'));
  });
}
...
var results_Segments = function (data) {
  ...
  var svg = d3.select("#viz-explore-results1").append("svg")
...
function callCustom(){
  var s_country = $('select#s-r-country1').val();
  var s_gender = $('select#s-r-gender1').val(); 
  var s_age = $('select#s-r-age1').val(); 
...
function redraw(){
  ...
  $("a#viz-custom-results1").click(function(event) {
...
function results_UI() {
    ...
    .append($('<div class="viz-dropdown-wrapper1 half"><select id="s-r-gender1" class="viz-dropdown"><option value="&gender=0">' + vizmetadata[ 'all' ] + '</option></select></br>'))
    .append($('<div class="viz-dropdown-wrapper1 half"><select id="s-r-age1" class="viz-dropdown"><option value="&age_ub=140">' + vizmetadata[ 'all' ] + '</option><option value="&age_ub=34">' + vizmetadata[ 'age1' ] + '</option><option value="&age_lb=35&age_ub=54">' + vizmetadata[ 'age2' ] + '</option><option value="&age_lb=55">' + vizmetadata[ 'age3' ] + '</option></select></br>'))
    .append($('<a href="#" class="btn btn-default" id="viz-custom-results1"">Change</a>'))


    $.each(countries, function(index, item){
      if (index > 0) {
        $("select#s-r-country1").append($('<option value="&country=' + item.id + '">' + item.name + "</option>"));
      }
    });

    $.each(genders, function(index, item){
      if (index > 0) {
        $("select#s-r-gender1").append($('<option value="&gender=' + item.id + '">' + item.name + "</option>"));
      }
    });    

    $("#s-r-country1").val("&country="+resultCountry).attr('selected',true);
    $("#s-r-gender1").val("&gender="+resultGender).attr('selected',true);
    $("#s-r-age1").val(resultAge).attr('selected',true);
...
var results_Segments2 = function (data) {
  var newdata; // Load Custom Segment
  var pad = 0.02;
  var padLarge = [0,5,5,10,10,10,15,15,15,15];
...
var results_Segments3 = function (data) {
  var newdata; // Load Custom Segment
  var pad = 0.02;
  var padLarge = [0,5,5,10,10,10,15,15,15,15];
  ...
  var svg = d3.select("#viz-explore-results3").append("svg")
    .attr("width", width + margin.left + margin.right)
    .attr("height", height + margin.top + margin.bottom)
    .append("g")
    .attr("transform", "translate(" + margin.left + "," + margin.top + ")");
...
function callCustom(){
  var s_country = $('select#s-r-country3').val();
  var s_gender = $('select#s-r-gender3').val(); 
  var s_age = $('select#s-r-age3').val(); 
...
function redraw(){
  ...
  $("a#viz-custom-results3").click(function(event) {
      event.preventDefault();
      callCustom();
   });   
...
function results_UI3() {

    $("#viz-explore-custom-results3 form")
    // .before($('<label class="'+current_lang+'">' + vizmetadata[ 'customize_this_segment' ] + '</label>'))
    .append($('<div class="viz-dropdown-wrapper3">'+
      // '<label for="s-r-country">' + vizmetadata[ 'region_or_country' ] + '</label>' + 
      '<select id="s-r-country3" class="viz-dropdown">' + 
      '<option value="&country=0">' + vizmetadata[ 'all' ] + '</option>' + 
      '<option value="&hdi=1">' + vizmetadata[ 'custom_dropdown_values' ][0] + '</option>' + 
      '<option value="&hdi=2">' + vizmetadata[ 'custom_dropdown_values' ][1] + '</option>' + 
      '<option value="&hdi=3">' + vizmetadata[ 'custom_dropdown_values' ][2] + '</option>' + 
    ...
    // .append($('<div class="viz-dropdown-wrapper half"><label for="s-r-gender">' + vizmetadata[ 'gender' ] + '</label><select id="s-r-gender" class="viz-dropdown"><option value="&gender=0">' + vizmetadata[ 'all' ] + '</option></select></br>'))
    // .append($('<div class="viz-dropdown-wrapper half"><label for="s-r-age">' + vizmetadata[ 'age_groups' ] + '</label><select id="s-r-age" class="viz-dropdown"><option value="&age_ub=140">' + vizmetadata[ 'all' ] + '</option><option value="&age_ub=34">' + vizmetadata[ 'age1' ] + '</option><option value="&age_lb=35&age_ub=54">' + vizmetadata[ 'age2' ] + '</option><option value="&age_lb=55">' + vizmetadata[ 'age3' ] + '</option></select></br>'))
    .append($('<div class="viz-dropdown-wrapper3 half"><select id="s-r-gender3" class="viz-dropdown"><option value="&gender=0">' + vizmetadata[ 'all' ] + '</option></select></br>'))
    .append($('<div class="viz-dropdown-wrapper3 half"><select id="s-r-age3" class="viz-dropdown"><option value="&age_ub=140">' + vizmetadata[ 'all' ] + '</option><option value="&age_ub=34">' + vizmetadata[ 'age1' ] + '</option><option value="&age_lb=35&age_ub=54">' + vizmetadata[ 'age2' ] + '</option><option value="&age_lb=55">' + vizmetadata[ 'age3' ] + '</option></select></br>'))
    .append($('<a href="#" class="btn btn-default" id="viz-custom-results3"">Change</a>'))


    $.each(countries, function(index, item){
      if (index > 0) {
        $("select#s-r-country3").append($('<option value="&country=' + item.id + '">' + item.name + "</option>"));
      }
    });

    $.each(genders, function(index, item){
      if (index > 0) {
        $("select#s-r-gender3").append($('<option value="&gender=' + item.id + '">' + item.name + "</option>"));
      }
    });    

    $("#s-r-country3").val("&country="+resultCountry).attr('selected',true);
    $("#s-r-gender3").val("&gender="+resultGender).attr('selected',true);
    $("#s-r-age2").val(resultAge).attr('selected',true);
