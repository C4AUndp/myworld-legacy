...
d3.csv("report/network.csv", function(rows) {
...
function resize() {
  var marginW = window.innerWidth/5;
  var marginH = window.innerHeight/5;

  widthF = window.innerWidth-marginW, heightF = window.innerHeight-marginH;
