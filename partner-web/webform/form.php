...
<!--Add more fields/Default amount is 10/-->
				...
				<br><br>
					<button class="btn_index" style="float:right; margin:-25px 10px 0px 0px;" disabled onClick="submitForms();" id="submitButton">Submit</button>
					<h1>Votes submission has been disabled temporarily.</h1>
