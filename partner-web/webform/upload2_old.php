...
<p style="color: #5E5E5E; font-size: 10pt; font-style: normal; margin: 0 0 30px;">Please upload your completed CSV file below:</p>
<form action="uploader.php" method="post" enctype="multipart/form-data">
	<input type="file" name="file" id="file" />
	<input id="submitbut" type="submit" name="submit" value="Upload" />
	</form>
			</table>
